...
const supplierBaseSchema = {
    ...
    contactPersons: joi.object({
        ke_toan_kho: joi.array().items(contactPersonSchema),
        ban_hang: joi.array().items(contactPersonSchema),
        ke_toan: joi.array().items(contactPersonSchema),
        ky_thuat: joi.array().items(contactPersonSchema),
        ke_toan_cong_no: joi.array().items(contactPersonSchema),
        ke_toan_hoa_don: joi.array().items(contactPersonSchema),
    }),
